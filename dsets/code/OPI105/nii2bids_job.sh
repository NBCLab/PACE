#!/bin/bash
#SBATCH --job-name=nii2bids_OPI105
...
# Outputs ----------------------------------
#SBATCH --output=log/nii2bids_OPI105-%j.out   
#SBATCH --error=log/nii2bids_OPI105-%j.err   
# ------------------------------------------
...
RAWS_DIR="${HOST_DIR}/${PROJECT}/raw/OPI105_JaneJoseph"
DATA="OPI105"
