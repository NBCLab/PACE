#!/bin/bash
#SBATCH --job-name=nii2bids_ALC134
...
# Outputs ----------------------------------
#SBATCH --output=log/nii2bids_ALC134-%j.out   
#SBATCH --error=log/nii2bids_ALC134-%j.err   
# ------------------------------------------
...
RAWS_DIR="${HOST_DIR}/${PROJECT}/raw/ALC134-Ramiro_Salas/sourcedata"
DATA="ALC134"
...
cmd="python -u ${CODE_DIR}/nii2bids2.py \
      --bids_dir ${BIDS_DIR} \
      --raw_dir ${RAWS_DIR} \
      >> log/logfile.log"
