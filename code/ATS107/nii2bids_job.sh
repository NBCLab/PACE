#!/bin/bash
#SBATCH --job-name=nii2bids_ATS107
...
# Outputs ----------------------------------
#SBATCH --output=log/nii2bids_ATS107-%j.out   
#SBATCH --error=log/nii2bids_ATS107-%j.err   
# ------------------------------------------
...
RAWS_DIR="${HOST_DIR}/${PROJECT}/raw/ATS107-Reneman_Schrantee/sourcedata"
DATA="ATS107"
