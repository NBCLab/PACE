#!/bin/bash
#SBATCH --job-name=nii2bids_OPI107
...
# Outputs ----------------------------------
#SBATCH --output=log/nii2bids_OPI107-%j.out   
#SBATCH --error=log/nii2bids_OPI107-%j.err   
# ------------------------------------------
...
RAWS_DIR="${HOST_DIR}/${PROJECT}/raw/OPI107_JaneJoseph/sourcedata"
DATA="OPI107"
