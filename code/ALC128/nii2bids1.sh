#!/bin/bash
#SBATCH --job-name=nii2bids_ALC128
...
# Outputs ----------------------------------
#SBATCH --output=log/nii2bids_ALC128-%j.out   
#SBATCH --error=log/nii2bids_ALC128-%j.err   
# ------------------------------------------
...
RAWS_DIR="${HOST_DIR}/${PROJECT}/raw/ALC128-Nicola_Cannessa/T1_RestingState_MRI_data"
DATA="ALC128"
...
cmd="python -u ${CODE_DIR}/nii2bids1.py \
      --bids_dir ${BIDS_DIR} \
      --raw_dir ${RAWS_DIR} \
      >> log/logfile.log"
