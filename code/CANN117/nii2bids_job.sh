#!/bin/bash
#SBATCH --job-name=nii2bids_CANN117
...
# Outputs ----------------------------------
#SBATCH --output=log/nii2bids_CANN117-%j.out   
#SBATCH --error=log/nii2bids_CANN117-%j.err   
# ------------------------------------------
...
RAWS_DIR="${HOST_DIR}/${PROJECT}/raw/CANN117_sourcedata_Janna_Cousijn/sourcedata"
DATA="CANN117"
